...
public class CustomerToo {
  ...
  public static CustomerToo fromJsonString(String jsonString) {
    Gson gson = new GsonBuilder().setPrettyPrinting().create();
    CustomerToo customer = new CustomerToo();
    try {
      customer = gson.fromJson(jsonString, CustomerToo.class);
